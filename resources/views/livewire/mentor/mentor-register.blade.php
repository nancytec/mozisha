                                    ...
                                    <div class="card-body" style=" padding-top: 13px; padding-bottom: 10px; ">
                                        <div class="login-header" >
                                            ...
                                            <div class="col-12" style="margin-top: -13px;">
                                                <a href="{{route('auth.mentor.google')}}" class="btn btn-default btn-block signup-google"> Sign up with<i class="ml-1"><img src="{{asset('user/img/google-logo.jpg')}}" alt="google-logo" style="width:60px;height:30px"/></i></a>
                                            </div>
