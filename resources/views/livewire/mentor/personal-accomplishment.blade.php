                        ...
                        <div class="row form-row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" wire:model="accomplish">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" wire:model="interest" name="interest">
                            ...
                            @if($showInterestForm == true)
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" wire:model="other_interest" name="interest">
                                            <option value="Null">Select Interest</option>
                                            <option value="Technology">Technology</option>
                                            <option value="Fashion">Fashion</option>
                                            <option value="Engineering">Engineering</option>
                            ...
                            @if($showAccomplishForm == true)
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="other_accomplish">
