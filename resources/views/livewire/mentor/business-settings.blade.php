        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="profile-sidebar">
                        <div class="user-widget">
                            <div class="user-info-cont">
                                <h4 class="usr-name">Get to know your company</h4>
                                <p class="mentor-type">Other information about your comapany.</p>
                            </div>
                        </div>
                    </div>
                    <!-- /Sidebar -->
                ...
                <div class="col-md-7 col-lg-8 col-xl-9">
                    ...
                    @livewire('company-info', ['user' => $user])
            ...
            @livewire('personal-accomplishment', ['user' => $user])
            <!--User's Experience Information-->
        </div>
