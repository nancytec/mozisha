                        ...
                        <div class="user-info-left align-items-center">
                            ...
                            <div class="user-info-cont">
                                ...
                                <div class="mentor-action">
                                    ...
                                    <a href="{{route('chat')}}" target="_blank" class="btn-blue" style="border-color: #420175; background-color: #420175;" >
...
{{--                                    </a>--}}
                        ...
                        <div class="user-info-right d-flex align-items-end flex-wrap">
                            <div class="hireme-btn text-center">
                                @if($status > 0)
                                <a class="blue-btn-radius" disabled="" style="border-color: #420175; background-color: #420175; color: white;" >Booked</a>
                                @else
                                    <a class="blue-btn-radius"   wire:click="apply" style="border-color: #420175; background-color: #420175; color: white; cursor: pointer;" > <i class="fa fa-spinner fa-spin" wire:loading wire:target="apply"></i> Easy Apply</a>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="widget about-widget custom-about mb-0">
                                        <h4 class="widget-title">About Apprenticeship</h4>
                                        <hr/>
                                        <p>{{$app->details}}</p>
                                    </div>
                                    <!-- /About Details -->
            ...
            <div class="card col-10 mr-auto ml-auto p-0">
                <div class="card-body custom-border-card pb-0">
                    ...
                    <div class="widget education-widget mb-0">
                        <h4 class="widget-title">Apprenticeship tasks</h4>
                        <hr/>
                        <div class="experience-box">
                            <ul class="">
                                @foreach($appDuty as $duty)
                                <li>{{$duty->duty}}</li>
                                @endforeach
                            </ul>
                        </div>
            ...
            <div class="card col-10 mr-auto ml-auto p-0">
                <div class="card-body custom-border-card pb-0">
                    ...
                    <!-- Personal Details -->
                    <div class="widget education-widget mb-0">
                        <h4 class="widget-title">Required Skills</h4>
                        <hr/>
                        <div class="experience-box">
                            <ul class="">
                                @foreach($appHelp as $help)
                                    <li>{{$help->help}}</li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div role="tabpanel" id="biography" class="tab-pane fade show active">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <!-- About Details -->
                                    <div class="widget about-widget custom-about mb-0">
                                        <h4 class="widget-title">About the mentor</h4>
                                        <hr/>
            ...
            <div class="card col-10 mr-auto ml-auto p-0">
                <div class="card-body custom-border-card pb-0">
                    ...
                    <!-- Personal Details -->
                    <div class="widget education-widget mb-0">
                        <h4 class="widget-title">Professional Accomplishments</h4>
                        <hr/>
                        <div class="experience-box">
                            <ul class="">
                                @foreach($accomp as $ac)
                                    <li>{{$ac->accomplishment}}</li>
                                @endforeach
                            </ul>
                        </div>
                        <h4 class="widget-title">Personal Interests</h4>
                        <hr/>
                        <div class="experience-box">
                            <ul class="">
                        ...
                        <div role="tabpanel" id="biography" class="tab-pane fade show active">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <!-- About Details -->
                                    <div class="widget about-widget custom-about mb-0">
                                        <h4 class="widget-title">Company Infomation</h4>
                                        <hr/>
                                        <h4>{{$company->name}}</h4>
