                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" wire:model="date" class="form-control" placeholder="Date of the meeting.">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" wire:model="details"
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" wire:model="hour" name="language">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" wire:model="minute" name="language">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" wire:model="meeting_id">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" wire:model="passcode">
