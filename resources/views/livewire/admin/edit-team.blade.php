                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="#" wire:submit.prevent="updateMember">
                                    <div class="row">
                                        <div class="col-xl-6">
                                    ...
                                    <div class="text-right">
                                        <button style="border-color: #420175; background-color: #420175;" type="submit" wire:loading wire:target="updateMember" class="btn btn-primary btn-lg"><i class="fa fa-spinner fa-spin"></i> Processing update..</button>
                                        <button class="btn btn-primary btn-lg" wire:loading.remove wire:target="updateMember" style="background-color: #420175; border-color: #420175;">Update Information</button>
                                    </div>
                                </form>
                            </div>
                        </div>
