        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Mozisha events</h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-table">
                            <div class="card-header">
                                <h4 class="card-title">Patron List: Total {{$count}}</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="/patron/{{$sub->id}}/profile" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{$sub->ImagePath}}" alt="User Image"></a>
                                                            <a href="/patron/{{$sub->id}}/profile">{{$sub->name}}</a>
                                                        </h2>
                                                    </td>
                                                    <td>{{$sub->phone}}</td>
                                                    <td>
