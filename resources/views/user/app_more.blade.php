                ...
                <div class="inner-page-header">
                    <div class="container pl-5 pr-5 p-lg-0">
                        <div class="bz-section-header inner-style2">
                            <h2 class="title">Mozisha<br>Apprenticeship Platform</h2>
                            <p class="desc mb-0">
                                We match learners with established businesses in order to deepen their entrepreneurial
                                knowledge and skills while they work in a online setting through Mozisha Apprenticeship.
