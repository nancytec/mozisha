                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="tbrr p30-15" style="padding: 60px 30px; border-radius:26px 26px 0px 0px;" bgcolor="#12325c">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="h1 pb25" style="color:#ffffff; font-family:'Muli', Arial,sans-serif; font-size:25px; line-height:46px; text-align:center; padding-bottom:25px;"><div mc:edit="text_2">Task solution!</div></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-center pb25" style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:12px; line-height:30px; text-align:left; padding-bottom:25px;"><div mc:edit="text_3">Hi {{$mail_data['name']}},<br/>
                                                                    This is to notify that  {{$mail_data['mentee_name']}} updated the solution to an apprenticeship task titled "{{$mail_data['task_title']}}", you can login to your
                                                                    apprenticeship dashboard to view the updated solution and feel free to reply as soon as possible.<br/>
